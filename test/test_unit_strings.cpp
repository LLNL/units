...
TEST(stringToUnit, handlingOfSquared)
{
    ...
    auto u3v = unit_from_string("kg per coulomb metre squared per second squared per volt");
    EXPECT_EQ(u3v, precise::kg/(precise::C * precise::m.pow(2)) / precise::V/precise::s.pow(2));
