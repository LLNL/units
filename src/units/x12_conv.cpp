...
static constexpr std::array<unitD, 486> x12_units{
  ...
  unitD{"95", "20,000 GALLON TANKCAR", precise_unit(20000, precise::gal) / precise::count},
  unitD{"96", "10,000 GALLON TANKCAR", precise_unit(10000, precise::gal) / precise::count},
  unitD{"97", "10 KILOGRAM DRUM", precise_unit(10, precise::kg) / precise::count},
  unitD{"98", "15 KILOGRAM DRUM", precise_unit(15, precise::kg) / precise::count},
  ...
  unitD{"B0", "BRITISH THERMAL UNITS PER CUBIC FOOT", precise::btu / (precise::ft.pow(3))},
  ...
  unitD{"K7", "KILOWATT", precise::kW},
  unitD{"K8", "KILOVOLT", precise::kV},
  ...
  unitD{"MP", "METRIC TON", precise::tonne},
  ...
  unitD{"S5", "SIXTY-FOURTHS OF AN INCH", precise_unit(1.0 / 64.0, precise::in)},
...
{
    auto ind = std::lower_bound(x12_units.begin(), x12_units.end(), x12_string,
...
{
    auto ind = std::lower_bound(dod_units.begin(), dod_units.end(), dod_string,
                                [](const unitD &u_set, const std::string &val) {
                                    return (strcmp(std::get<0>(u_set), val.c_str()) < 0);
                                });
