...
namespace precise {
    ...
    static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 2088> r20_units = { {
        ...
        unitD{"17", "hundred lb drum",{ hundred * lb, commodities::packaging::drum}},
        unitD{"18", "fiftyfive gallon (US) drum", {55.0, us::gallon}},
        unitD{"19", "tank truck", {1.0,count, commodities::packaging::tanktruck}},
        unitD{"1A", "car mile", {mile, commodities::packaging::car}},
        ...
        unitD{"1F", "train mile", {mile, commodities::packaging::train}},
        unitD{"1G", "fuel usage gallon (US)", us::gallon},
        unitD{"1H", "caboose mile", {mile, commodities::packaging::caboose}},
        ...
        unitD{ "AM", "ampoule", {count,commodities::packaging::ampoule} },
        ...
        unitD{ "AS", "assortment", {count,commodities::packaging::assortment} },
        ...
        unitD{"AV", "capsule", {count,commodities::packaging::capsule}},
        unitD{"AW", "powder filled vial", one / count},
        unitD{ "AY", "assembly", {count,commodities::packaging::assembly} },
        unitD{
            "AZ",
        ...
        unitD{"E28", "air dry ton", precise_unit(ton,commodities::packaging::dry)},
        ...
        unitD{"MD", "air dry metric ton", precise_unit(tonne,commodities::packaging::dry)},
        ...
        unitD{"NY", "pound per air dry metric ton", lb/precise_unit(tonne,commodities::packaging::dry)},
        ...
        unitD{"RL", "reel",precise_unit(count,commodities::packaging::reel)},
        ...
        unitD{"SA", "sack", precise_unit(count,commodities::packaging::sack)},
        ...
        unitD{"SET", "set", precise_unit(count,commodities::packaging::set)},
        ...
        unitD{"T0", "telecommunication line in service", precise_unit(count,commodities::linesofservice)},
        ...
        unitD{"TL", "thousand foot (linear)", thousand*ft*iflag},
        ...
        unitD{"UC", "telecommunication port", precise_unit(1,count,commodities::port)},
        ...
        unitD{"WB", "wet pound", precise_unit(lb,commodities::packaging::dry)},
        unitD{"WCD", "cord", us::cord},
        unitD{"WE", "wet ton", precise_unit(ton,commodities::packaging::dry)},
        ...
        unitD{"WM", "working month", precise_unit(time::mog,commodities::labor)},
        unitD{"WR", "wrap", precise_unit(count,commodities::packaging::wrap)},
        ...
        unitD{"Z3", "cask", precise_unit(count,commodities::packaging::cask)},
        ...
        unitD{"ZP", "page", precise_unit(count,commodities::packaging::page)},
        unitD{"ZZ", "mutually defined", count},
    }};
