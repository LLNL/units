...
namespace precise {
    ...
    static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 2088> r20_units = { {
        ...
        unitD{"30", "horse power day per air dry metric ton", hp * day / precise_unit(t,commodities::packaging::dry)},
        unitD{"31", "catch weight", pu*lb},
        unitD{"32", "kilogram per air dry metric ton", kg/precise_unit(t,commodities::packaging::dry)},
        ...
        unitD{"CCT", "carrying capacity in metric ton", {1.0,t,commodities::packaging::capacity}},
        ...
        unitD{ "D23", "pen gram (protein)", precise_unit(g,commodities::protein) },
        ...
        unitD{ "DPC", "dozen piece", {12.0,count,commodities::packaging::piece} },
        unitD{"DPR", "dozen pair", precise_unit(24.0,count)},
        unitD{ "DPT", "displacement tonnage", {1.0,ton,commodities::packaging::displacement} },
        ...
        unitD{"E15", "kilocalorie (thermochemical) per hour", kilo*energy::cal_th/hr},
        ...
        unitD{ "E4", "gross kilogram", {1.0,kg,commodities::packaging::gross_quantity} },
        ...
        unitD{ "GFI", "gram of fissile isotope", {1.0,g,commodities::fissile_material} },
        ...
        unitD{ "HPA", "hectolitre of pure alcohol", {1.0,hecto * L,commodities::ethanol} },
        ...
        unitD{ "ISD", "international sugar degree", {1.0,generate_custom_unit(107),commodities::sugar} },
        ...
        unitD{"J17", "degree Balling", {1.0,generate_custom_unit(109),commodities::sugar}},
        unitD{"J18", "degree Brix", {1.0,generate_custom_unit(108),commodities::sugar}},
        unitD{
            "J19",
        ...
        unitD{"J27", "degree Oechsle", {1.0,generate_custom_unit(110),commodities::sugar}},
        ...
        unitD{"LUM", "lumen", lm},
        unitD{"LUX", "lux", lux},
        unitD{ "LX", "linear yard per pound", precise_unit(1.0,yd,commodities::packaging::linear) / lb},
        ...
        unitD{ "MF", "milligram per square foot per side", {1.0,mg / ft.pow(2) / precise_unit(one,commodities::packaging::side)} },
        ...
        unitD{ "ND", "net barrel", {1.0,us::barrel,commodities::packaging::net_quantity} },
        ...
        unitD{ "NT", "net ton", {1.0,ton,commodities::packaging::net_quantity} },
        unitD{ "NTT", "net register ton", {1.0,ton,commodities::packaging::net_register} },
        ...
        unitD{ "PE", "pound equivalent", {10.0,lb,commodities::packaging::equivalent} },
        unitD{"PF", "pallet (lift)", {1.0, count,commodities::packaging::pallet}},
        unitD{"PFL", "proof litre", {1.0,L,commodities::packaging::equivalent + commodities::chemicals::alcohol}},
        unitD{"PG", "plate", {1.0, count,commodities::packaging::plate}},
        unitD{"PGL", "proof gallon", {1.0,gal,commodities::packaging::equivalent + commodities::chemicals::alcohol}},
        ...
        unitD{"PLA", "degree Plato", {1.0,generate_custom_unit(112),commodities::sugar}},
        unitD{"PM", "pound percentage", lb*percent},
        unitD{"PN", "pound net", {1.0,lb,commodities::packaging::net_quantity}},
        unitD{"PO", "pound per inch of length", lb/in},
        unitD{"PQ", "page per inch",  {1.0,count/in, commodities::packaging::page}},
        ...
        unitD{ "RH", "running or operating hour", {1.0,hr,commodities::runtime} },
        ...
        unitD{"TW", "thousand sheet", precise_unit(1.0,thousand,commodities::packaging::sheet)},
        ...
        unitD{"UB", "telecommunication line in service average", precise_unit(1.0,count,commodities::linesofservice)},
        unitD{ "UC", "telecommunication port", {1.0,count,commodities::port} },
        unitD{"UD", "tenth minute", {0.1, min}},
        unitD{"UE", "tenth hour", {0.1, hr}},
        unitD{"UF", "usage per telecommunication line average", count/precise_unit(1.0,one,commodities::linesofservice)},
