...
namespace precise {
    ...
    static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 2088> r20_units = { {
        ...
        unitD{"06", "small spray", {1.0,count, commodities::packaging::small_spray}},
        ...
        unitD{"15", "stick, military", {1.0,count, commodities::packaging::stick}},
        unitD{"16", "hundred fifteen kg drum", {115.0, kg, commodities::packaging::drum}},
        unitD{"17", "hundred lb drum",{100.0, lb, commodities::packaging::drum}},
        unitD{"18", "fiftyfive gallon (US) drum", {55.0, us::gallon, commodities::packaging::drum}},
        ...
        unitD{"1C", "locomotive count", {1.0, count, commodities::packaging::locomotive}},
        ...
        unitD{"1K", "locomotive mile", {1.0, mile, commodities::packaging::locomotive}},
        unitD{"1L", "total car count", {1.0, count, commodities::packaging::car}},
        ...
        unitD{"24", "theoretical pound", {1.0, lb,commodities::packaging::theoretical}},
        unitD{"25", "gram per square centimetre", g / cm.pow(2)},
        unitD{"26", "actual ton", {1.0, ton,commodities::packaging::actual}},
        unitD{"27", "theoretical ton", {1.0, ton,commodities::packaging::theoretical}},
        ...
        unitD{"30", "horse power day per air dry metric ton", hp * day / precise_unit(tonne,commodities::packaging::dry)},
        unitD{"31", "catch weight", pu*lb},
        unitD{"32", "kilogram per air dry metric ton", kg/precise_unit(tonne,commodities::packaging::dry)},
        ...
        unitD{"3G", "pound per piece of product", kg/count},
        ...
        unitD{"43", "super bulk bag", {1.0,count, commodities::packaging::bulk_bag}},
        unitD{"44", "fivehundred kg bulk bag", {500.0,kg, commodities::packaging::bulk_bag}},
        unitD{"45", "threehundred kg bulk bag", {300.0,kg, commodities::packaging::bulk_bag}},
        unitD{"46", "fifty lb bulk bag", {50.0,lb, commodities::packaging::bulk_bag}},
        ...
        unitD{"53", "theoretical kilogram", {1.0, kg,commodities::packaging::theoretical}},
        unitD{"54", "theoretical tonne", {1.0, mass::tonne,commodities::packaging::theoretical}},
        unitD{"56", "sitas", {100.0, m.pow(2)}},
        unitD{"57", "mesh", clinical::mesh},
        unitD{"58", "net kilogram", {1.0, kg,commodities::packaging::net_quantity}},
        ...
        unitD{ "63", "failure rate in time", {1.0, count / s,commodities::failure} },
        ...
        unitD{ "95", "twenty thousand gallon (US) tankcar", {20000.0, us::gallon, commodities::packaging::tankcar} },
        unitD{"96", "ten thousand gallon (US) tankcar", {10000.0, us::gallon, commodities::packaging::tankcar}},
        unitD{"97", "ten kg drum", {10.0, kg, commodities::packaging::drum}},
        unitD{"98", "fifteen kg drum", {15.0,kg,commodities::packaging::drum}},
        ...
        unitD{ "A43", "deadweight tonnage", {1.0, mass::tonne,commodities::packaging::deadweight} },
        ...
        unitD{ "A59", "8-part cloud cover", {constants::pi / 4,sr,commodities::cloud_cover} },
        ...
        unitD{ "A75", "freight ton", {1.0, ton,commodities::packaging::freight} },
        ...
        unitD{ "AI", "average minute per call", min / precise_unit(one,commodities::call) },
        ...
        unitD{"ASM", "alcoholic strength by mass", {1.0, pu*kg,commodities::ethanol}},
        ...
        unitD{"B82", "inch per linear foot", in/ft*iflag},
        ...
        unitD{"BR", "bar [unit of packaging]", {1.0, count,commodities::packaging::bar}},
        ...
        unitD{"C1", "composite product pound (total weight)", {1.0, lb,commodities::packaging::composite}},
        ...
        unitD{"CCT", "carrying capacity in metric ton", {tonne,commodities::packaging::capacity}},
        ...
        unitD{"CLF", "hundred leave", {100.0,count,commodities::packaging::leave}},
        ...
        unitD{"CWA", "hundred pound (cwt) / hundred weight (US)", av::hundredweight },
        ...
        unitD{"D04", "lot  [unit of weight]", {1.0, count,commodities::packaging::lot}},
        ...
        unitD{"D14", "thousand linear yard", thousand*yd*iflag},
        ...
        unitD{ "D23", "pen gram (protein)", {g,commodities::protein} },
        ...
        unitD{"D66", "cassette", {1.0, count,commodities::packaging::cassette}},
        ...
        unitD{ "D7", "sandwich", {1.0, count,commodities::generateHarmonizedCode(19,05,90,80,false)} },
        ...
        unitD{"D97", "pallet/unit load", {1.0, count,commodities::packaging::pallet}},
        ...
        unitD{ "DPT", "displacement tonnage", {ton,commodities::packaging::displacement} },
        ...
        unitD{"DT", "dry ton", {ton,commodities::packaging::dry}},
        ...
        unitD{"DY", "directory book", {1.0, count,commodities::packaging::book}},
        ...
        unitD{ "E21", "shares", {1.0, count,commodities::generateShareCode("     ")} },
        ...
        unitD{ "E28", "air dry ton", {ton,commodities::packaging::dry} },
        unitD{"E3", "trailer", {ton,commodities::packaging::dry}},
        unitD{"E30", "strand", {ton,commodities::packaging::strand}},
        ...
        unitD{"E38", "megapixel", {mega*count,commodities::pixel}},
        unitD{"E39", "dots per inch", {count/in,commodities::dots}},
        unitD{ "E4", "gross kilogram", {kg,commodities::packaging::gross_quantity} },
        unitD{"E40", "part per hundred thousand", count/(hundred*thousand)},
        unitD{"E41", "kilogram-force per square millimetre", precise::kilo* precise::gm::pond/mm.pow(2)},
        unitD{"E42", "kilogram-force per square centimetre", precise::kilo* precise::gm::pond/cm.pow(2)},
        unitD{"E43", "joule per square centimetre", J/cm.pow(2)},
        unitD{"E44", "kilogram-force metre per square centimetre", precise::kilo* precise::gm::pond*m/cm.pow(2)},
        ...
        unitD{ "E49", "working day", {day,commodities::labor} },
        ...
        unitD{ "E52", "run foot", {ft,commodities::packaging::run} },
        ...
        unitD{"EA", "each", one},
        unitD{ "EB", "electronic mail box", {1.0, count,commodities::electronic_mail_box} },
        ...
        unitD{"F9", "fibre per cubic centimetre of air", precise_unit(count,commodities::fiber)/precise_unit(cm.pow(3),commodities::air)},
        ...
        unitD{ "FBM", "fibre metre", {meter,commodities::fiber} },
        unitD{"FC", "thousand cubic foot", thousand*ft.pow(3)},
        unitD{ "FD", "million particle per cubic foot", precise_unit{mega * count / ft.pow(3),commodities::packaging::particle} },
        unitD{ "FE", "track foot", {ft,commodities::packaging::track} },
        ...
        unitD{"FH", "micromole", micro*mol},
             unitD{
                 ...
                 unitD{ "FL", "flake ton", {ton,commodities::packaging::flake} },
        ...
        unitD{ "G7", "microfiche sheet", {1.0, count,commodities::packaging::sheet} },
        ...
        unitD{ "GD", "gross barrel", {144.0,count,commodities::packaging::barrel} },
        unitD{"GDW", "gram, dry weight", g},
        unitD{"GE", "pound per gallon (US)", lb/us::gallon},
        unitD{"GF", "gram per metre (gram per 100 centimetres)", g/m},
        unitD{ "GFI", "gram of fissile isotope", {g,commodities::fissile_material} },
        ...
        unitD{ "H1", "half page - electronic", {0.5,count,commodities::packaging::page_electronic} },
        ...
        unitD{"H41", "newton metre watt to the power minus 0,5", generate_custom_unit(879)},
        ...
        unitD{ "H78", "conventional centimetre of water", {10.0,precise::pressure::mmH2O} },
        ...
        unitD{"H85", "reciprocal week", time::week.inv()},
             unitD{"H87", "piece", {one, commodities::packaging::piece}},
        ...
        unitD{ "HBX", "hundred boxes", {100.0, count,commodities::packaging::box} },
        ...
        unitD{"HEA", "head", { count,commodities::packaging::head}},
        unitD{"HF", "hundred foot", hundred*foot},
        unitD{"HGM", "hectogram", hecto*g},
        unitD{"HH", "hundred cubic foot", hundred*ft.pow(3)},
        unitD{"HI", "hundred sheet", {100.0, count,commodities::packaging::sheet}},
        unitD{ "HIU", "hundred international unit", {100.0, precise::laboratory::IU} },
        ...
        unitD{"HL", "hundred foot (linear)", hundred*ft*iflag},
        ...
        unitD{ "HPA", "hectolitre of pure alcohol", {hecto * L,commodities::ethanol} },
        ...
        unitD{ "ISD", "international sugar degree", {generate_custom_unit(107),commodities::sugar} },
        ...
        unitD{"J14", "degree Baume (origin scale)", special::degreeBaume},
        unitD{"J15", "degree Baume (US heavy)", special::degreeBaume},
        unitD{"J16", "degree Baume (US light)", special::degreeBaume},
        unitD{"J17", "degree Balling", {generate_custom_unit(109),commodities::sugar}},
        unitD{"J18", "degree Brix", {generate_custom_unit(108),commodities::sugar}},
        unitD{
            "J19",
        ...
        unitD{"J27", "degree Oechsle", {generate_custom_unit(110),commodities::sugar}},
        ...
        unitD{"JNT", "pipeline joint", {1.0, count,commodities::packaging::joint}},
        ...
        unitD{ "KB", "kilocharacter", {kilo * count,commodities::character} },
        unitD{"KBA", "kilobar", kilo*bar},
        unitD{ "KCC", "kilogram of choline chloride", {kg,commodities::chemicals::choline_chloride} },
        unitD{"KD", "kilogram decimal", kg},
        unitD{ "KDW", "kilogram drained net weight", {kg,commodities::packaging::net_quantity} },
        unitD{"KEL", "kelvin", K},
        unitD{"KF", "kilopacket", {1000.0, count,commodities::packaging::packet}},
        unitD{ "KG", "keg", {1.0, count,commodities::packaging::keg} },
        unitD{"KGM", "kilogram", kg},
        unitD{"KGS", "kilogram per second", kg/s},
        unitD{ "KHY", "kilogram of hydrogen peroxide", {kg,commodities::hydrogen_peroxide} },
        ...
        unitD{ "KJ", "kilosegment", {kilo * count,commodities::packaging::segment} },
        unitD{"KJO", "kilojoule", kilo*J},
        unitD{"KL", "kilogram per metre", kg/m},
        unitD{ "KLK", "lactic dry material percentage", {percent,commodities::packaging::dry + commodities::milk} },
        unitD{"KLX", "kilolux", kilo*lux},
        unitD{ "KMA", "kilogram of methylamine", {kg, commodities::chemicals::methylamine} },
        ...
        unitD{ "KWO", "kilogram of tungsten trioxide", {kg,commodities::chemicals::W03} },
        ...
        unitD{ "LAC", "lactose excess percentage", {percent,commodities::packaging::excess+commodities::lactose} },
        unitD{"LBR", "pound", lb},
        unitD{"LBT", "troy pound (US)", troy::pound},
        unitD{"LC", "linear centimetre", cm*iflag},
        ...
        unitD{"LF", "linear foot", ft*iflag},
        unitD{ "LH", "labour hour", {hr,commodities::labor} },
        unitD{"LI", "linear inch", in*iflag},
        unitD{ "LJ", "large spray", {1.0, count,commodities::packaging::large_spray} },
        unitD{"LK", "link", {1.0, count,commodities::packaging::length} },
        unitD{"LM", "linear metre", m*iflag},
        unitD{"LN", "length", {1.0, count,commodities::packaging::large_spray} },
        unitD{"LO", "lot  [unit of procurement]", {1.0, count,commodities::packaging::lot} },
        unitD{ "LP", "liquid pound", {lb,commodities::packaging::liquid} },
        unitD{ "LPA", "litre of pure alcohol", {L,commodities::chemicals::alcohol} },
        unitD{"LR", "layer", {1.0, count,commodities::packaging::layer} },
        unitD{ "LS", "lump sum", {currency,commodities::packaging::lump} },
        unitD{"LTN", "ton (UK)", av::longton},
        unitD{"LTR", "litre", L},
        unitD{"LUB", "metric ton, lubricating oil", t},
        unitD{"LUM", "lumen", lm},
        unitD{"LUX", "lux", lux},
        unitD{"LX", "linear yard per pound", yd*iflag/lb},
        unitD{"LY", "linear yard", yd*iflag},
        unitD{ "M0", "magnetic tape", {1.0, count,commodities::generateHarmonizedCode(85,23,29,15,false)} },
        ...
        unitD{ "MA", "machine per unit", {pu * count,commodities::machine} },
        ...
        unitD{ "MBE", "thousand standard brick equivalent", {1000.0,count,commodities::brick} },
        ...
        unitD{ "MF", "milligram per square foot per side", {mg / ft.pow(2) / precise_unit(one,commodities::packaging::side)} },
        ...
        unitD{"N13", "centimetre of mercury (0 degC)", pressure::mmHg},
        ...
        unitD{"N20", "kip per square inch", precise::kilo* precise::lbf/in.pow(2)},
        ...
        unitD{"N70", "quad (1015 BtuIT)", energy::quad},
        ...
        unitD{"NAR", "number of articles", {1.0, count,commodities::packaging::article} },
        unitD{"NB", "barge", {1.0, count,commodities::packaging::barge} },
        unitD{"NBB", "number of bobbins", {1.0, count,commodities::packaging::bobbin} },
        unitD{ "NC", "car", {1.0, count,commodities::packaging::car} },
        unitD{"NCL", "number of cells", {1.0, count,commodities::cell}},
        unitD{ "ND", "net barrel", {us::barrel,commodities::packaging::net_quantity} },
        unitD{ "NE", "net litre", {L,commodities::packaging::net} },
        unitD{"NEW", "newton", N},
        unitD{ "NF", "message", {1.0, count,commodities::message} },
        unitD{ "NG", "net gallon (us)", {gal,commodities::packaging::net} },
        unitD{ "NH", "message hour", {hr,commodities::message} },
        unitD{ "NI", "net imperial gallon", {imp::gallon,commodities::packaging::net} },
        ...
        unitD{"NMP", "number of packs",  {1.0, count, commodities::packaging::pack}},
        unitD{"NN", "train",  {1.0, count, commodities::packaging::train}},
        unitD{"NPL", "number of parcels",  {1.0, count, commodities::packaging::parcel}},
        unitD{ "NPR", "number of pairs", {2.0, count} },
        unitD{"NPT", "number of parts",  {1.0, count, commodities::packaging::part}},
        unitD{"NQ", "mho", ohm.inv()},
        unitD{"NR", "micromho", micro*ohm.inv()},
        unitD{ "NRL", "number of rolls", {1.0, count,commodities::packaging::roll} },
        unitD{ "NT", "net ton", {ton,commodities::packaging::net_quantity} },
        unitD{ "NTT", "net register ton", {ton,commodities::packaging::net_register} },
        unitD{"NU", "newton metre", N*m},
        unitD{"NV", "vehicle",  {1.0, count, commodities::vehicle}},
        unitD{"NX", "part per thousand", milli*count},
        unitD{"NY", "pound per air dry metric ton", lb/precise_unit(mass::tonne,commodities::packaging::dry)},
        ...
        unitD{"PE", "pound equivalent", lb},
        unitD{"PF", "pallet (lift)", {1.0, count,commodities::packaging::pallet}},
        unitD{"PFL", "proof litre", {L,commodities::packaging::equivalent + commodities::chemicals::alcohol}},
        unitD{"PG", "plate", {1.0, count,commodities::packaging::plate}},
        unitD{"PGL", "proof gallon", {gal,commodities::packaging::equivalent + commodities::chemicals::alcohol}},
        unitD{"PI", "pitch", {count/in,commodities::character}},
        unitD{"PK", "pack",  {1.0, count, commodities::packaging::pack}},
        unitD{"PL", "pail",  {1.0, count, commodities::packaging::pail}},
        unitD{"PLA", "degree Plato", {generate_custom_unit(112),commodities::sugar}},
        unitD{"PM", "pound percentage", lb*percent},
        unitD{"PN", "pound net", {lb,commodities::packaging::net_quantity}},
        unitD{"PO", "pound per inch of length", lb/in},
        unitD{"PQ", "page per inch",  {count/in, commodities::packaging::page}},
        ...
        unitD{"PU", "tray / tray pack", {1.0, count,commodities::packaging::tray}},
        ...
        unitD{ "QA", "page - facsimile", {1.0, count,commodities::packaging::page} },
        unitD{"QAN", "quarter (of a year)", {0.25, yr}},
        unitD{"QB", "page - hardcopy", {1.0, count,commodities::packaging::page+commodities::paper} },
        unitD{"QD", "quarter dozen", {3, one}},
        unitD{"QH", "quarter hour", {0.25, hr}},
        unitD{"QK", "quarter kilogram", {0.25, kg}},
        unitD{"QR", "quire", {25.0,count,commodities::packaging::sheet + commodities::paper}},
        ...
        unitD{ "RH", "running or operating hour", {hr,commodities::runtime} },
        unitD{"RK", "roll metric measure", { count, commodities::packaging::roll}},
        ...
        unitD{"S7", "storage unit", {1.0, count,commodities::packaging::storage_unit}},
        ...
        unitD{ "SD", "solid pound", {lb,commodities::packaging::bulk} },
        ...
        unitD{"SHT", "shipping ton", ton},
        unitD{"SIE", "siemens", S},
        unitD{ "SK", "split tank truck", {1.0, count,commodities::packaging::split_tank_truck} },
        unitD{ "SL", "slipsheet", {1.0, count, commodities::packaging::slipsheet} },
        unitD{"SMI", "statute mile", i::mile},
        ...
        unitD{"SQR", "square, roofing", {1.0, count,commodities::packaging::square}},
        unitD{"SR", "strip", {1.0, count,commodities::packaging::strip}},
        unitD{"SS", "sheet metric measure", {1.0, count,commodities::packaging::sheet}},
        unitD{"SST", "short standard (7200 matches)", {7200.0,count,commodities::matches}},
        ...
        unitD{"STK", "stick, cigarette", {1.0, count,commodities::packaging::stick+commodities::cigarette}},
        ...
        unitD{ "T0", "telecommunication line in service", {1.0, count,commodities::linesofservice} },
        unitD{"T1", "thousand pound gross", {1000.0,lb,commodities::packaging::gross_quantity}},
        unitD{"T3", "thousand piece", {1000.0, count, commodities::packaging::piece}},
        unitD{"T4", "thousand bag", {1000.0, count, commodities::packaging::bag}},
        unitD{"T5", "thousand casing", {1000.0, count, commodities::packaging::casing}},
        unitD{"T6", "thousand gallon (US)", thousand*us::gallon},
        unitD{"T7", "thousand impression", {1000.0,count,commodities::impression}},
        unitD{"T8", "thousand linear inch", thousand*in*iflag},
        ...
        unitD{ "TK", "tank, rectangular", {1.0, count, commodities::packaging::tank} },
        unitD{"TKM", "tonne kilometre", mass::tonne* km},
        unitD{"TL", "thousand foot", thousand*ft*iflag},
        unitD{"TMS", "kilogram of imported meat, less offal", {1.0,kg,commodities::generateHarmonizedCode(1,2,0)}},
        ...
        unitD{ "TSD", "tonne of substance 90 % dry", {1.0,mass::tonne,commodities::packaging::dry90} },
        unitD{"TSH", "ton of steam per hour", precise_unit(ton,commodities::steam)/hr},
        unitD{"TST", "ten set", {10, count,commodities::packaging::set}},
        unitD{"TT", "thousand linear metre", thousand*m*iflag},
        unitD{"TTS", "ten thousand sticks", precise_unit(10000,count,commodities::packaging::stick)},
        unitD{"TU", "tube", precise_unit(1,count,commodities::packaging::tube)},
        unitD{"TV", "thousand kilogram", thousand*kg},
        unitD{"TW", "thousand sheet", precise_unit(thousand,commodities::packaging::sheet)},
        unitD{"TY", "tank, cylindrical", precise_unit(1,count,commodities::packaging::cylindrical_tank)},
        unitD{"U1", "treatment", {1.0, count,commodities::packaging::treatment}},
        unitD{"U2", "tablet", precise_unit(count,commodities::packaging::tablet)},
        unitD{"UA", "torr", pressure::torr},
        unitD{"UB", "telecommunication line in service average", precise_unit(1,count,commodities::linesofservice)},
        unitD{ "UC", "telecommunication port", {1,count,commodities::port} },
        unitD{"UD", "tenth minute", {0.1, min}},
        unitD{"UE", "tenth hour", {0.1, hr}},
        unitD{"UF", "usage per telecommunication line average", count/precise_unit(one,commodities::linesofservice)},
        ...
        unitD{ "WM", "working month", {time::mog,commodities::labor} },
        ...
        unitD{ "YL", "hundred linear yard", {100.0,yd*iflag} },
        unitD{"YRD", "yard", yd},
        unitD{ "YT", "ten yard", {10.0,yd} },
        unitD{"Z1", "lift van", precise_unit(count,commodities::packaging::lift_van)},
        unitD{"Z11", "hanging container", precise_unit(count,commodities::packaging::hanging_container)},
        ...
        unitD{"Z8", "newspage agate line", precise_unit(1.0/14, in)*precise_unit(2.0,in)},
