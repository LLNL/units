...
namespace precise {
    ...
    static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 2088> r20_units = { {
        ...
        unitD{ "B82", "inch per linear foot", in / precise_unit(1.0,ft,commodities::packaging::linear ) },
        ...
        unitD{"D14", "thousand linear yard", {1000.0,yd,commodities::packaging::linear} },
        ...
        unitD{ "KB", "kilocharacter", {1.0,kilo * count,commodities::character} },
        unitD{"KBA", "kilobar", kilo*bar},
        unitD{ "KCC", "kilogram of choline chloride", {1.0,kg,commodities::chemicals::choline_chloride} },
        unitD{"KD", "kilogram decimal", kg},
        unitD{ "KDW", "kilogram drained net weight", {1.0,kg,commodities::packaging::net_quantity} },
        unitD{"KEL", "kelvin", K},
        ...
        unitD{ "KHY", "kilogram of hydrogen peroxide", {1.0,kg,commodities::hydrogen_peroxide} },
        ...
        unitD{ "KJ", "kilosegment", {1.0,kilo * count,commodities::packaging::segment} },
        unitD{"KJO", "kilojoule", kilo*J},
        unitD{"KL", "kilogram per metre", kg/m},
        unitD{ "KLK", "lactic dry material percentage", {1.0,percent,commodities::packaging::dry + commodities::milk} },
        unitD{"KLX", "kilolux", kilo*lux},
        unitD{ "KMA", "kilogram of methylamine", {1.0,kg, commodities::chemicals::methylamine} },
        ...
        unitD{
            ...
            {1.0,milli / g,commodities::packaging::equivalent + commodities::chemicals::KOH }},
        unitD{"KPA", "kilopascal", kilo*Pa},
        unitD{
            "KPH",
            "kilogram of potassium hydroxide (caustic potash)",
            {kg,commodities::chemicals::KOH} },
        unitD{"KPO", "kilogram of potassium oxide", {1.0,kg,commodities::chemicals::K2O} },
        unitD{
            "KPP",
        ...
        unitD{ "KSD", "kilogram of substance 90 % dry", {1.0,kg,commodities::packaging::dry90} },
        unitD{
            "KSH",
        ...
        unitD{ "KWO", "kilogram of tungsten trioxide", {1.0,kg,commodities::chemicals::W03} },
        ...
        unitD{ "LAC", "lactose excess percentage", {1.0,percent,commodities::packaging::excess+commodities::lactose} },
        unitD{"LBR", "pound", lb},
        unitD{"LBT", "troy pound (US)", troy::pound},
        unitD{"LC", "linear centimetre", {1.0,cm,commodities::packaging::linear} },
        ...
        unitD{ "LPA", "litre of pure alcohol", {1.0,L,commodities::chemicals::alcohol} },
        ...
        unitD{"LUM", "lumen", lm},
        unitD{"LUX", "lux", lux},
        unitD{ "LX", "linear yard per pound", precise_unit(yd,commodities::packaging::linear) / lb},
        ...
        unitD{"P29", "footlambert", {1.0 / constants::pi, precise::cd / precise::ft.pow(2)}},
        ...
        unitD{ "PE", "pound equivalent", {10,lb,commodities::packaging::equivalent} },
        ...
        unitD{ "T8", "thousand linear inch", {1000.0,in,commodities::packaging::linear} },
        ...
        unitD{"TSH", "ton of steam per hour", precise_unit(1.0,ton,commodities::steam)/hr},
        ...
        unitD{"TY", "tank, cylindrical", precise_unit(1.0,count,commodities::packaging::cylindrical_tank)},
        unitD{"U1", "treatment", {1.0, count,commodities::packaging::treatment}},
        unitD{"U2", "tablet", precise_unit(1.0,count,commodities::packaging::tablet)},
        ...
        unitD{ "YL", "hundred linear yard", {100.0,yd,commodities::packaging::linear} },
        unitD{"YRD", "yard", yd},
