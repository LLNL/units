...
static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 486> x12_units{{
    ...
    unitD{"BZ", "MILLION BTUS/DEKATHERM", precise::mega* precise::btu / precise_unit(10.0, precise::energy::therm_ec)},
    ...
    unitD{"DL", "DECILITER", precise::deci*precise::L},
    unitD{"DM", "DECIMETER", precise::deci*precise::meter},
