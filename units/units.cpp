...
static const std::unordered_map<std::uint64_t, precise_unit> domainSpecificUnit{
    ...
    {hashGen(domains::cooking, "c"), precise::us::cup},
    {hashGen(domains::cooking,"smi"), precise_unit(1.0 / 32.0, precise::us::tsp)},
    {hashGen(domains::cooking,"scruple"), precise_unit(1.0 / 4.0, precise::us::tsp)},
    {hashGen(domains::cooking, "t"), precise::us::tsp},
    {hashGen(domains::cooking, "ds"), precise_unit(1.0 / 16.0, precise::us::tsp)},
