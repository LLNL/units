...
UNITS_CPP14_CONSTEXPR_OBJECT std::array<
    ...
    defined_unit_strings_si{{
        ...
        {"osmol", precise_unit(1.0, precise::mol, commodities::packaging::particle)},
        {"OSM", precise_unit(1.0, precise::mol, commodities::packaging::particle)},
        ...
        {"ozonedepletionequivalent", precise::climate::odp},  // ozone depletion equivalent
        {"min", precise::min},
...
UNITS_CPP14_CONSTEXPR_OBJECT std::array<
    ...
    defined_unit_strings_customary{
        ...
        {"theoretical",{1.0,precise::one,commodities::packaging::theoretical}},
